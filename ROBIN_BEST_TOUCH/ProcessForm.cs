    ...
    public class ProcessForm
    {
        ...
        public void ProcessStart(int stepState, int stepStateMax)
        {
            ...
            switch (stepState)
            {
                ...
                case 2:
                    this.MainFrm.lblStep2.Text = "2     TÜM LEDLERİN KONTROL TESTİ";
                    break;

                case 3:
                    this.MainFrm.lblStep3.Text = "3     FCT HABERLEŞME BAŞLANGIÇ TESTİ";
                    break;

                case 4:
                    this.MainFrm.lblStep4.Text = "4     FCT YAZILIM VERSİYON KONTROL TESTİ";
                    break;

                case 5:
                    this.MainFrm.lblStep5.Text = "5     YAZILIM VERSİYON KONTROL TESTİ";
                    break;

                case 6:
                    this.MainFrm.lblStep6.Text = "6     VOC I2C KONTROL TESTİ";
                    break;

                case 7:
                    this.MainFrm.lblStep7.Text = "7     MAINBOARD I2C KONTROL TESTİ";
                    break;

                case 8:
                    this.MainFrm.lblStep8.Text = "8     NTC SENSÖR KONTROL TESTİ";
                    break;

                case 9:
                    this.MainFrm.lblStep9.Text = "9     BUTTON INIT KONTROL TESTİ";
                    break;

                case 10:
                    this.MainFrm.lblStep10.Text = "10    BUTTON KONTROL TESTİ";
                    break;
        ...
        public void ProcessSuccess(int stepState)  
        {
            switch (stepState)
            {
                ...
                case 8:
                    ...
                    this.MainFrm.fonksiyonTestInsert(Convert.ToString(stepState), this.MainFrm.lblStep8.Text, "PASSED", "0", "0", "0", "1", "NULL");
                    break;
                ...
                case 9:
                    ...
                    this.MainFrm.fonksiyonTestInsert(Convert.ToString(stepState), this.MainFrm.lblStep9.Text, "PASSED", "0", "0", "0", "1", "NULL");
                    break;
                ...
                case 10:
                    ...
                    this.MainFrm.fonksiyonTestInsert(Convert.ToString(stepState), this.MainFrm.lblStep10.Text, "PASSED", "0", "0", "0", "1", "NULL");
                    break;
