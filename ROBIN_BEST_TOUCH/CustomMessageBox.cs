            ...
            switch (button)
            {
                    ...
                    using (FormMessageOK msgOK = new FormMessageOK())
                    {
                        ...
                        switch (icon)
                        {
                            case CustomMessageBoxIcon.Information:
                                msgOK.MessageIcon = ROBIN_BEST_TOUCH.Properties.Resources.info_128x128;
                                break;
                            case CustomMessageBoxIcon.Question:
                                msgOK.MessageIcon = ROBIN_BEST_TOUCH.Properties.Resources.info_128x128;
                                break;
                            case CustomMessageBoxIcon.Error:
                                msgOK.MessageIcon = ROBIN_BEST_TOUCH.Properties.Resources.error_128x128;
                                break;
                            case CustomMessageBoxIcon.Pass:
                                msgOK.MessageIcon = ROBIN_BEST_TOUCH.Properties.Resources.ok_128x128;
                                break;
                            case CustomMessageBoxIcon.Fail:
                                msgOK.MessageIcon = ROBIN_BEST_TOUCH.Properties.Resources.cross_128x128;
                                break;
                ...
                case MessageBoxButtons.YesNo:
                    using (FormMessageYesNo msgYesNo = new FormMessageYesNo())
                    {
                        ...
                        {
                            case CustomMessageBoxIcon.Information:
                                msgYesNo.MessageIcon = ROBIN_BEST_TOUCH.Properties.Resources.info_128x128;
                                break;
                            case CustomMessageBoxIcon.Question:
                                msgYesNo.MessageIcon = ROBIN_BEST_TOUCH.Properties.Resources.info_128x128;
                                break;
                            case CustomMessageBoxIcon.Error:
                                msgYesNo.MessageIcon = ROBIN_BEST_TOUCH.Properties.Resources.error_128x128;
                                break;
                            case CustomMessageBoxIcon.Pass:
                                msgYesNo.MessageIcon = ROBIN_BEST_TOUCH.Properties.Resources.ok_128x128;
                                break;
                            case CustomMessageBoxIcon.Fail:
                                msgYesNo.MessageIcon = ROBIN_BEST_TOUCH.Properties.Resources.cross_128x128;
                                break;
                            case CustomMessageBoxIcon.Warning:
                                msgYesNo.MessageIcon = ROBIN_BEST_TOUCH.Properties.Resources.error_128x128;
                                break;
                ...
                case MessageBoxButtons.OKCancel:
                    using (FormMessageOKCancel msgOKCancel = new FormMessageOKCancel())
                    {
                        ...
                        {
                            case CustomMessageBoxIcon.Information:
                                msgOKCancel.MessageIcon = ROBIN_BEST_TOUCH.Properties.Resources.info_128x128;
                                break;
                            case CustomMessageBoxIcon.Question:
                                msgOKCancel.MessageIcon = ROBIN_BEST_TOUCH.Properties.Resources.info_128x128;
                                break;
                            case CustomMessageBoxIcon.Error:
                                msgOKCancel.MessageIcon = ROBIN_BEST_TOUCH.Properties.Resources.error_128x128;
                                break;
                            case CustomMessageBoxIcon.Pass:
                                msgOKCancel.MessageIcon = ROBIN_BEST_TOUCH.Properties.Resources.ok_128x128;
                                break;
                            case CustomMessageBoxIcon.Fail:
                                msgOKCancel.MessageIcon = ROBIN_BEST_TOUCH.Properties.Resources.cross_128x128;
                                break;
                            case CustomMessageBoxIcon.Warning:
                                msgOKCancel.MessageIcon = ROBIN_BEST_TOUCH.Properties.Resources.error_128x128;
                                break;
